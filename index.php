...
<!-- w3school online 
 ini dapat digunakan jika anda online namun anda bisa menggunakan cara 
yang diatas sehingga proses offline dan online bisa sama
...
<body style="background: #343A40;">
	...
	<div class="container-fluid p-2 bg-danger text-white">
		<div class="row">
			...
			<div class="col-2"><span class="text-center">Hai <?php echo$_SESSION['sesi']; ?>!</span></div>
		</div>
	</div>
